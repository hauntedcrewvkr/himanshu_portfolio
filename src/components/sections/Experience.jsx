      ...
      <div className="skills-stack">
        <div className="skill-row">
          <div className="skill-info">
            ...
            <p>Leading end-to-end development initiatives. Architecting universal CRUD engines and optimizing core WordPress systems for diverse client ecosystems.</p>
          </div>
